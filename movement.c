  ...
  */
  ...
  case 'w':
    ...
    if (!((map_array[*player_row - 1][*player_col] == '*') ||
          (map_array[*player_row - 1][*player_col] == 'O')))

    {
      ...
      if ((isnear(*player_col, *player_row, *box_col, *box_row) == 'w')) {
        ...
        /* Markign Criteria: Assignment 2 Player and box should not be able to
         * pass through the wall.  */
        if ((map_array[*box_row - 1][*box_col] != '*') &&
            (map_array[*box_row - 1][*box_col] != 'O')) {
          *box_row = *box_row - 1;
        }
      } else if (((pull) && (isnear(*player_col, *player_row, *box_col,
                                    *box_row) == 's'))) {
